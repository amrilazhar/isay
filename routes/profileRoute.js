...
let dir = (req, res, next) => {
	req.directory = "images/backgroundimages/";
	next();
};
//view our profile
router.get(
...
router.get(
	...
	isAuth,
	setProfileId,
	profileController.myProfileActivities
);
...
router.get(
	...
	isAuth,
	setProfileId,
	profileController.anotherProfile
);
router.get(
	"/an/Post/:id",
	tokenParser,
	isAuth,
	setProfileId,
	profileController.anotherProfilePost
);
router.get(
	"/an/Activities/:id",
	tokenParser,
	isAuth,
	setProfileId,
	profileController.anotherProfileActivities
);
...
router.get(
	...
	isAuth,
	setProfileId,
	profileController.getAvatarList
);
...
router.put(
	...
	isAuth,
	setProfileId,
	profileController.deleteInterest
);
router.get(
	"/userInterest",
	tokenParser,
	isAuth,
	setProfileId,
	profileController.getListUserInterest
);
router.put(
	"/",
	tokenParser,
